...
import styles from "./MyChats3IPhone11Pro.module.css";

const MyChats3IPhone11Pro: FunctionComponent = () => {
  const navigate = useNavigate();

  const onAppBarnavigationIconContainerClick = useCallback(() => {
    navigate("/my-chats-2-iphone-11-pro");
  }, [navigate]);

  const onSearchbarNewGroupselectClick = useCallback(() => {
    navigate("/my-chats-4-iphone-11-pro");
  }, [navigate]);

  return (
    <div className={styles.myChats3Iphone11Pro}>
      <div className={styles.statusBar}>
        <img className={styles.statusBarBg} alt="" />
        <div className={styles.carrier}>
          <div className={styles.carrierFrame}>Teamzr</div>
        </div>
      ...
      <div className={styles.appbarmenu}>
        ...
        <div className={styles.frameappbarnavigationicon}>
          <div
        ...
        <div className={styles.frameappbarnavigationicon1}>
      ...
      <main
        className={styles.searchbarnewgroupselect}
        onClick={onSearchbarNewGroupselectClick}
      >
        <div className={styles.dropdown} />
        <b className={styles.suggested}>Suggested</b>
        <section className={styles.frameComponent}>
          <div className={styles.frameNesting}>
            <div className={styles.instanceFrame}>
              <div className={styles.itemTwo}>
                ...
                />
                <div className={styles.textNode}>Ashley Bradley</div>
            ...
            <div className={styles.iconButton}>
              <div className={styles.masterlarge3}>
                <img className={styles.icons4} alt="" src="/icons-41.svg" />
              </div>
            </div>
          </div>
          <div className={styles.frameNesting1}>
          ...
          <div className={styles.frameNesting2}>
            ...
            <div className={styles.iconButton2}>
              <div className={styles.masterlarge5}>
                <img className={styles.icons8} alt="" src="/icons-41.svg" />
              </div>
            </div>
          </div>
          <div className={styles.frameNesting3}>
            ...
            <div className={styles.iconButton3}>
              <div className={styles.masterlarge6}>
                <img className={styles.icons10} alt="" src="/icons-41.svg" />
              </div>
            </div>
          </div>
          <div className={styles.frameNesting4}>
          ...
          <div className={styles.frameNesting5}>
            <div className={styles.itemOne1}>
              <img
                ...
                src="/avatar-31@2x.png"
              />
              <div className={styles.instanceGroupText}>Sabrina Davies</div>
            </div>
          ...
          <div className={styles.frameNesting6}>
          ...
          <div className={styles.frameNesting7}>
            ...
            <div className={styles.iconButton7}>
              <div className={styles.masterlarge10}>
                <img className={styles.icons15} alt="" src="/icons-41.svg" />
              </div>
            </div>
          </div>
          <div className={styles.frameNesting8}>
          ...
          <div className={styles.frameNesting9}>
          ...
          <div className={styles.frameNesting10}>
          ...
          <footer className={styles.frameNesting11}>
...
export default MyChats3IPhone11Pro;
