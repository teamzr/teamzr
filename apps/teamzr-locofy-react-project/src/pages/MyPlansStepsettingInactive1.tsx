...
import styles from "./MyPlansStepsettingInactive1.module.css";

const MyPlansStepsettingInactive1: FunctionComponent = () => {
  ...
  return (
    <div className={styles.myPlansStepsettingInactive}>
      ...
      <main className={styles.myPlansStepsettingInactiveInner}>
        <section className={styles.frameGroup}>
          <div className={styles.chipSETPlansAllInstanceParent}>
            <div className={styles.chipSETPlansAllInstance}>
                      ...
                      <div className={styles.appbarNavigationIcon}>
                        ...
                        <div className={styles.stepper1}>
                          <div className={styles.selectArrow}>
                            <div className={styles.selectarrow}>14 / 40</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className={styles.textfield}>
                      <div className={styles.content4}>
                        ...
                        <div className={styles.inputText1}>
                          ...
                          >{`The discovery of the functionality "Format `}</div>
                        </div>
                      </div>
                      <div className={styles.howToSummarizeChildrenStep}>
          ...
          <div className={styles.masterFrame}>
            ...
            <div className={styles.autocomplete}>
              ...
              <div className={styles.startEndText1}>
              ...
              <button className={styles.startEndText2}>
          ...
          <div className={styles.frameContainer}>
            <div className={styles.typographyInstances}>
              <div className={styles.typographyInstances1}>
                <div className={styles.typographyInstances2}>
                  <div className={styles.typography3}>
                    <div className={styles.h62}>Duration</div>
                  </div>
                </div>
                <div className={styles.rewardGroupInstance}>
          ...
          <div className={styles.autocompleteFrame}>
            <div className={styles.autocompleteLine}>
                      ...
                      <div className={styles.inputTextField}>
                        ...
                        <div className={styles.selectLabel}>
                          <div className={styles.selectArrow2}>
                            <div className={styles.inputField}>0 / 40</div>
                          </div>
                        </div>
                      </div>
...
export default MyPlansStepsettingInactive1;
