...
import styles from "./MyChats1IPhone11Pro.module.css";

const MyChats1IPhone11Pro: FunctionComponent = () => {
  const onCardClick = useCallback(() => {
    // Please sync "My chats_7_(iPhone 11 Pro)" to the project
  }, []);
  ...
  return (
    <div className={styles.myChats1Iphone11Pro}>
      <div className={styles.statusBar}>
        <img className={styles.statusBarBg} alt="" />
        <div className={styles.carrier}>
          <div className={styles.frameBottomNavigation}>Teamzr</div>
        </div>
        <div className={styles.appbarNavigationIcon}>
          ...
          <div className={styles.time}>
            <div className={styles.chipSE}>12:30</div>
          </div>
        </div>
      </div>
      <div className={styles.appbarmenu}>
        ...
        <div className={styles.framebottomnavigation}>
          <div className={styles.appBarnavigationIcon}>
        ...
        <div className={styles.chipSetInstance}>
        ...
        <div className={styles.chipsetplansall}>
          <div className={styles.chip}>
            <div className={styles.masterdefaultdefault}>
              ...
              <div className={styles.medium7}>All</div>
              <img className={styles.closeFrameIcon7} alt="" />
            </div>
          </div>
          <div className={styles.chipoutlinedmediumprimaryt7}>
            <div className={styles.masterdefaultoutlined7}>
              <div className={styles.avatariconFrame8}>
                <img className={styles.masterelementsavatarimageIcon8} alt="" />
                <img className={styles.masterelementsicon8} alt="" />
                <div className={styles.masterelementsavatarletter8}>
                  <div className={styles.f8}>F</div>
                </div>
              </div>
              <div className={styles.medium8}>Groups</div>
              <img className={styles.closeFrameIcon8} alt="" />
            </div>
          </div>
          <div className={styles.chipoutlinedmediumprimaryt8}>
            <div className={styles.masterdefaultoutlined8}>
              <div className={styles.avatariconFrame9}>
                <img className={styles.masterelementsavatarimageIcon9} alt="" />
                <img className={styles.masterelementsicon9} alt="" />
                <div className={styles.masterelementsavatarletter9}>
                  <div className={styles.f9}>F</div>
                </div>
              </div>
              <div className={styles.medium9}>Individuals</div>
              <img className={styles.closeFrameIcon9} alt="" />
            </div>
          </div>
          <div className={styles.chipoutlinedmediumprimaryt9}>
            <div className={styles.masterdefaultoutlined9}>
              <div className={styles.avatariconFrame10}>
                <img
                  className={styles.masterelementsavatarimageIcon10}
                  alt=""
                />
                <img className={styles.masterelementsicon10} alt="" />
                <div className={styles.masterelementsavatarletter10}>
                  <div className={styles.f10}>F</div>
                </div>
              </div>
              <div className={styles.medium10}>Drafts</div>
              <img className={styles.closeFrameIcon10} alt="" />
            </div>
          </div>
          <div className={styles.chipoutlinedmediumprimaryt10}>
            <div className={styles.masterdefaultoutlined10}>
              <div className={styles.avatariconFrame11}>
                <img
                  className={styles.masterelementsavatarimageIcon11}
                  alt=""
                />
                <img className={styles.masterelementsicon11} alt="" />
                <div className={styles.masterelementsavatarletter11}>
                  <div className={styles.f11}>F</div>
                </div>
              </div>
              <div className={styles.medium11}>Bookmarks</div>
              <img className={styles.closeFrameIcon11} alt="" />
            </div>
          </div>
          <div className={styles.chipoutlinedmediumprimaryt11}>
            <div className={styles.masterdefaultoutlined11}>
              <div className={styles.avatariconFrame12}>
                <img
                  className={styles.masterelementsavatarimageIcon12}
                  alt=""
                />
                <img className={styles.masterelementsicon12} alt="" />
                <div className={styles.masterelementsavatarletter12}>
                  <div className={styles.f12}>F</div>
                </div>
              </div>
              <div className={styles.medium12}>Published</div>
              <img className={styles.closeFrameIcon12} alt="" />
            </div>
          </div>
          <div className={styles.chipoutlinedmediumprimaryt12}>
            <div className={styles.masterdefaultoutlined12}>
              <div className={styles.avatariconFrame13}>
                <img
                  className={styles.masterelementsavatarimageIcon13}
                  alt=""
                />
                <img className={styles.masterelementsicon13} alt="" />
                <div className={styles.masterelementsavatarletter13}>
                  <div className={styles.f13}>F</div>
                </div>
              </div>
              <div className={styles.medium13}>WebApp</div>
              <img className={styles.closeFrameIcon13} alt="" />
            </div>
          </div>
          <div className={styles.chipoutlinedmediumprimaryt13}>
            <div className={styles.masterdefaultoutlined13}>
              <div className={styles.avatariconFrame14}>
                <img
                  className={styles.masterelementsavatarimageIcon14}
                  alt=""
                />
                <img className={styles.masterelementsicon14} alt="" />
                <div className={styles.masterelementsavatarletter14}>
                  <div className={styles.f14}>F</div>
                </div>
              </div>
              <div className={styles.medium14}>Classes</div>
              <img className={styles.closeFrameIcon14} alt="" />
            </div>
          </div>
        </div>
      </div>
      <main className={styles.userplanset}>
        <section className={styles.card} onClick={onCardClick}>
          ...
          <img className={styles.badgekrokProbhIcon} alt="" />
          <div className={styles.avatar}>
            <img className={styles.avatarIcon2} alt="" src="/avatar-1@2x.png" />
          ...
          <div className={styles.cardElements}>
            <div className={styles.multiframecontainerWrapper}>
              <div className={styles.multiframecontainer}>
                <div className={styles.component}>
                  <div className={styles.september142016}>Mládež ŠPK</div>
                </div>
                <div className={styles.component1}>
                  <i className={styles.september1420161}>6:41 PM</i>
                </div>
              </div>
            </div>
            <div className={styles.typography1}>
              <b className={styles.body2}>
                <p
                  className={styles.theyKnowYou}
                >{`They know you can do anything `}</p>
                <p className={styles.youWantTrust}>{`you want, trust me!! `}</p>
              </b>
            </div>
        ...
        <img
          ...
          src="/divider.svg"
        />
        <section className={styles.card1} onClick={onCard1Click}>
          ...
          <img className={styles.badgekrokProbhIcon1} alt="" />
          <div className={styles.avatar1}>
            <img className={styles.avatarIcon4} alt="" src="/avatar-2@2x.png" />
            <div className={styles.followbadge3}>
              <div className={styles.masterroundsmall9}>
                <img className={styles.icons12} alt="" src="/icons-121.svg" />
              </div>
            </div>
          </div>
          <div className={styles.cardElements1}>
            <div className={styles.cardElementsInner}>
              <div className={styles.componentParent}>
                <div className={styles.component2}>
                  <div className={styles.september1420162}>
                    Sabrina Rodriguez
                  </div>
                </div>
                <div className={styles.component3}>
                  <i className={styles.september1420163}>6:41 PM</i>
                </div>
              </div>
            </div>
            <div className={styles.typography2}>
              <b className={styles.body21}>
                <p
                  className={styles.theyKnowYou1}
                >{`They know you can do anything `}</p>
                <p
                  className={styles.youWantTrust1}
                >{`you want, trust me!! `}</p>
              </b>
            </div>
            <div className={styles.masterlarge3}>
              <img className={styles.icons13} alt="" src="/icons-7.svg" />
            </div>
          </div>
        </section>
          ...
          <div className={styles.card2} onClick={onCardContainerClick}>
            ...
            <div className={styles.badgeBookmark2}>
              <div className={styles.masterroundsmall13}>
                <img className={styles.icons17} alt="" />
              </div>
            </div>
            <img className={styles.badgekrokProbhIcon2} alt="" />
            <div className={styles.avatar2}>
              ...
              <div className={styles.followbadge5}>
                <div className={styles.masterroundsmall14}>
                  <img className={styles.icons18} alt="" src="/icons-181.svg" />
                </div>
              </div>
            </div>
            <div className={styles.cardElements2}>
              <div className={styles.componentGroup}>
                <div className={styles.component4}>
                  <div className={styles.september1420164}>Chess Club 2021</div>
                </div>
                <div className={styles.component5}>
                  <i className={styles.september1420165}>yesterday</i>
                </div>
              </div>
              ...
              <div className={styles.masterlarge4}>
                <img className={styles.icons19} alt="" src="/icons-7.svg" />
              </div>
            </div>
          </div>
        </section>
        <img className={styles.dividerIcon2} alt="" src="/divider.svg" />
        <section className={styles.cardFrame1}>
          <div className={styles.card3} onClick={onCardContainer2Click}>
            ...
            <div className={styles.badgePublished3}>
              <div className={styles.masterroundsmall17}>
                <img className={styles.icons22} alt="" />
              </div>
            </div>
            ...
            <img className={styles.badgekrokProbhIcon3} alt="" />
            <div className={styles.avatar3}>
              ...
              <div className={styles.followbadge7}>
                <div className={styles.masterroundsmall19}>
                  <img className={styles.icons24} alt="" src="/icons-241.svg" />
                </div>
              </div>
            </div>
            <div className={styles.cardElements3}>
              <div className={styles.componentContainer}>
                <div className={styles.component6}>
                  <div className={styles.september1420166}>User name</div>
                </div>
                <div className={styles.component7}>
                  <i className={styles.september1420167}>yesterday</i>
                </div>
              </div>
              <div className={styles.typography4}>
                <div className={styles.body23}>
                  Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                  Aenean commodo ligula...
                </div>
              </div>
              <div className={styles.masterlarge5}>
                <img className={styles.icons25} alt="" src="/icons-7.svg" />
              </div>
            </div>
          </div>
        </section>
        <img className={styles.dividerIcon3} alt="" src="/divider.svg" />
        <section className={styles.cardFrame2}>
          <div className={styles.card4} onClick={onCardContainer3Click}>
            <img className={styles.avatarIcon9} alt="" src="/avatar@2x.png" />
            <img className={styles.groupIcon4} alt="" />
            <div className={styles.followbadge8}>
            ...
            <img className={styles.badgekrokProbhIcon4} alt="" />
            <div className={styles.avatar4}>
              <img
                ...
                src="/avatar-5@2x.png"
              />
              <div className={styles.followbadge9}>
                <div className={styles.masterroundsmall24}>
                  <img className={styles.icons30} alt="" src="/icons-30.svg" />
                </div>
              </div>
            </div>
            <div className={styles.cardElements4}>
              <div className={styles.frameDiv}>
                <div className={styles.component8}>
                  <div className={styles.september1420168}>Group name</div>
                </div>
                <div className={styles.component9}>
                  <i className={styles.september1420169}>yesterday</i>
                </div>
              </div>
              ...
              <div className={styles.masterlarge6}>
                <img className={styles.icons31} alt="" src="/icons-7.svg" />
              </div>
            </div>
          </div>
        </section>
        <img className={styles.dividerIcon4} alt="" src="/divider.svg" />
        <section className={styles.cardFrame3}>
          <div className={styles.card5} onClick={onCardContainer4Click}>
            <img className={styles.avatarIcon11} alt="" src="/avatar@2x.png" />
            <img className={styles.groupIcon5} alt="" />
            <div className={styles.followbadge10}>
              <div className={styles.masterroundsmall25}>
                <img className={styles.icons32} alt="" />
              </div>
            </div>
            ...
            <img className={styles.badgekrokProbhIcon5} alt="" />
            <div className={styles.avatar5}>
              <img
                ...
                src="/avatar-5@2x.png"
              />
              <div className={styles.followbadge11}>
                <div className={styles.masterroundsmall29}>
                  <img className={styles.icons37} alt="" src="/icons-30.svg" />
                </div>
              </div>
            </div>
            <div className={styles.cardElements5}>
              <div className={styles.cardElementsFrames}>
                <div className={styles.component10}>
                  <div className={styles.september14201610}>User name</div>
                </div>
                <div className={styles.component11}>
                  <i className={styles.september14201611}>yesterday</i>
                </div>
              </div>
              ...
              <div className={styles.masterlarge7}>
                <img className={styles.icons38} alt="" src="/icons-7.svg" />
              </div>
            </div>
          </div>
        </section>
        <img className={styles.dividerIcon5} alt="" src="/divider.svg" />
        <section className={styles.card6} onClick={onCard2Click}>
          <img className={styles.avatarIcon13} alt="" src="/avatar@2x.png" />
          <img className={styles.groupIcon6} alt="" />
          <div className={styles.followbadge12}>
          ...
          <div className={styles.badgePublished6}>
            <div className={styles.masterroundsmall32}>
              <img className={styles.icons41} alt="" />
            </div>
          </div>
          <div className={styles.badgeBookmark6}>
            <div className={styles.masterroundsmall33}>
              <img className={styles.icons42} alt="" />
            </div>
          </div>
          <img className={styles.badgekrokProbhIcon6} alt="" />
          <div className={styles.avatar6}>
            <img
              ...
              src="/avatar-7@2x.png"
            />
            <div className={styles.followbadge13}>
              <div className={styles.masterroundsmall34}>
          ...
          <div className={styles.cardElements6}>
            <div className={styles.componentParent1}>
              <div className={styles.component12}>
                <div className={styles.september14201612}>User name</div>
              </div>
              <div className={styles.component13}>
                <i className={styles.september14201613}>yesterday</i>
              </div>
            </div>
            <div className={styles.typography7}>
              <div className={styles.body26}>
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean
                commodo ligula...
              </div>
            </div>
            <div className={styles.masterlarge8}>
              <img className={styles.icons44} alt="" />
            </div>
          </div>
        </section>
        <img className={styles.dividerIcon6} alt="" />
        <section className={styles.card7} onClick={onCard3Click}>
          <img className={styles.avatarIcon15} alt="" src="/avatar@2x.png" />
          <img className={styles.groupIcon7} alt="" />
          <div className={styles.followbadge14}>
            <div className={styles.masterroundsmall35}>
              <img className={styles.icons45} alt="" />
            </div>
          </div>
          <div className={styles.badgeVisible7}>
            <div className={styles.masterroundsmall36}>
              <img className={styles.icons46} alt="" />
            </div>
          </div>
          <div className={styles.badgePublished7}>
            <div className={styles.masterroundsmall37}>
              <img className={styles.icons47} alt="" />
            </div>
          </div>
          <div className={styles.badgeBookmark7}>
            <div className={styles.masterroundsmall38}>
              <img className={styles.icons48} alt="" />
            </div>
          </div>
          <img className={styles.badgekrokProbhIcon7} alt="" />
          <div className={styles.avatar7}>
            <img
              ...
              src="/avatar-8@2x.png"
            />
            <div className={styles.followbadge15}>
              <div className={styles.masterroundsmall39}>
                <img className={styles.icons49} alt="" />
              </div>
            </div>
          </div>
          <div className={styles.cardElements7}>
            <div className={styles.componentParent2}>
              <div className={styles.component14}>
                <div className={styles.september14201614}>User name</div>
              </div>
              <div className={styles.component15}>
                <i className={styles.september14201615}>yesterday</i>
              </div>
            </div>
            ...
            <div className={styles.masterlarge9}>
              <img className={styles.icons50} alt="" />
            </div>
          </div>
        </section>
        <img className={styles.dividerIcon7} alt="" />
        <section className={styles.card8} onClick={onCard4Click}>
          <img className={styles.avatarIcon17} alt="" src="/avatar@2x.png" />
          <img className={styles.groupIcon8} alt="" />
          <div className={styles.followbadge16}>
            <div className={styles.masterroundsmall40}>
              <img className={styles.icons51} alt="" />
            </div>
          </div>
          <div className={styles.badgeVisible8}>
            <div className={styles.masterroundsmall41}>
              <img className={styles.icons52} alt="" />
            </div>
          </div>
          <div className={styles.badgePublished8}>
            <div className={styles.masterroundsmall42}>
              <img className={styles.icons53} alt="" />
            </div>
          </div>
          <div className={styles.badgeBookmark8}>
            <div className={styles.masterroundsmall43}>
              <img className={styles.icons54} alt="" />
            </div>
          </div>
          <img className={styles.badgekrokProbhIcon8} alt="" />
          <div className={styles.avatar8}>
            <img
              ...
              src="/avatar-9@2x.png"
            />
            <div className={styles.followbadge17}>
              <div className={styles.masterroundsmall44}>
                <img className={styles.icons55} alt="" />
              </div>
            </div>
          </div>
          <div className={styles.cardElements8}>
            <div className={styles.componentParent3}>
              <div className={styles.component16}>
                <div className={styles.september14201616}>Group name</div>
              </div>
              <div className={styles.component17}>
                <i className={styles.september14201617}>yesterday</i>
              </div>
            </div>
            <div className={styles.typography9}>
              <div className={styles.body28}>
                Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean
                commodo ligula...
              </div>
            </div>
            <div className={styles.masterlarge10}>
              <img className={styles.icons56} alt="" />
            </div>
          </div>
        </section>
...
export default MyChats1IPhone11Pro;
